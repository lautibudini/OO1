...
public class JobSchedulerTest {
    ...
    private JobScheduler newFifoScheduler() {
    	FifoStrategy fifoScheduler = new FifoStrategy();
        return fifoScheduler;
    }

    private JobScheduler newLifoScheduler() {
        LifoStrategy lifoScheduler = new LifoStrategy();
        return lifoScheduler;
    }

    private JobScheduler newPriorityScheduler() {
        JobScheduler priorityScheduler = new HighestPriorityStrategy();
        return priorityScheduler;
    }

    private JobScheduler newEffortScheduler() {
    	MostEffortStrategy effortScheduler = new MostEffortStrategy();
    ...
    @Test
    void testSchedule() {
    	JobScheduler aScheduler = new HighestPriorityStrategy();
